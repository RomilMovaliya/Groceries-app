...
import { getUserSession, logout } from "../../supabase/auth/authFunction";
...
const AccountScreen = () => {
  ...
  useEffect(() => {
    const fetchUserInfo = async () => {
      ...
      if (userInfo.success) {
        setName(userInfo.user.session.user.user_metadata.display_name);
        setEmail(userInfo.user.session.user.user_metadata.email);
        console.log(
          "userInfo",
          userInfo.user.session.user.user_metadata.display_name
        );
      }
    };
    fetchUserInfo();
